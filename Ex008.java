...
public class Ex008{
    ...
    public static void main (String [] args){
        ...
        Double pesopeixe, excesso, multa; 
      ...
      excesso= pesopeixe-50;
       ...
       if (pesopeixe > 50 )
       System.out.println("O excesso do peso do peixe é de " +excesso+ " e a multa é de: "+multa);
       
       else 
       System.out.println("O peso do peixe não passou do excesso e não tera multa");
